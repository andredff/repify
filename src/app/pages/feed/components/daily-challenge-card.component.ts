      ...
      <div class="relative space-y-4">
        <div class="flex items-start justify-between gap-4">
          <div>
            ...
            <h2 class="mt-2 text-[24px] font-display font-bold tracking-tight text-white">{{ title() }}</h2>
        ...
        <div class="grid grid-cols-2 gap-2.5 text-left">
          <div class="rounded-2xl border border-white/6 bg-white/[0.03] px-3.5 py-3">
          ...
          <div class="rounded-2xl border border-white/6 bg-primary/[0.05] px-3.5 py-3">
        ...
        <div class="flex items-center justify-between gap-3 rounded-2xl border border-white/6 bg-black/20 px-3.5 py-3">
